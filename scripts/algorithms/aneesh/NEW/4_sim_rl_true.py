...
simple              +       reinforcement learning [but reward = true idleness]     + change in decision making
...
class AN_MRPP:
    ...
    def callback_next_task(self, req):
        ...
        if rand > epsilon:
            ...
            for n in neigh:
                ...
                idles.append(self.idle_expect[bot][n] + maxQ)
    ...
    def callback_ready(self, req):
        algo_name = req.algo
        if algo_name == '4_sim_rl_true' and self.ready:
