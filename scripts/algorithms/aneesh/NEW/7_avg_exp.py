...
avg                           +       reinforcement learning         +           change in value_exp
(average expected idleness)            (value function)              (adding the effect of high expected idleness)
AN_MRPP
epsilon-greedy
...
class AN_MRPP:
    ...
    def callback_ready(self, req):
        algo_name = req.algo
        if algo_name == '7_avg_exp' and self.ready:
