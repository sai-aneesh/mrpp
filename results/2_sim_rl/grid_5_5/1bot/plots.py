...
for file in fileNames:
    ...
    for elem in df['current node'].unique():
        ...
        plt.scatter(new_df["time"], new_df["expect-true"])
...
for file in fileNames:
    ...
    for elem in df['current node'].unique():
        new_df = df[df['current node'] == elem]
        plt.scatter(new_df["time"], new_df["expect"])
    plt.legend(df['current node'].unique(),loc = 'center left')
...
for file in fileNames:
    ...
    for elem in df['current node'].unique():
        new_df = df[df['current node'] == elem]
        plt.scatter(new_df["time"], new_df["true"])
    plt.legend(df['current node'].unique(),loc = 'center left')
...
for file in fileNames:
    ...
    for elem in df['current node'].unique():
        new_df = df[df['current node'] == elem]
        plt.scatter(new_df["time"], new_df["probability (value_exp)"])
    plt.legend(df['current node'].unique(),loc = 'center left')
